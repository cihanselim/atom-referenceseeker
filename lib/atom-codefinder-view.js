...
export default class AtomCodefinderView {
  ...
  constructor(serializedState) {
    ...
    myLabel.setAttribute("style", "height: 30px; width: 80px; align: center; margin-top:10px; margin-bottom:10px;");
    this.element.appendChild(myLabel);

    //searching for it
    var myButton = document.createElement('button');
    myButton.value = "GO";
    myButton.setAttribute("style", "height: 30px; width: 80px; align: center; float:right; margin-top:10px; margin-bottom:10px;");
