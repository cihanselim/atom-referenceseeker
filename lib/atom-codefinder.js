...
export default {
  ...
  activate(state) {
    ...
    // var css_urls = JSON.parse(fs.readFileSync(__dirname + '/data/MDN_CSS/urls.json', 'utf8'));
    // var html_urls = JSON.parse(fs.readFileSync(__dirname + '/data/MDN_HTML/urls.json', 'utf8'));
    // var js_urls = JSON.parse(fs.readFileSync(__dirname + '/data/MDN_JS/urls.json', 'utf8'));
